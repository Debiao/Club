...
- (void)formUploadWithFileData:(NSData *)data
    ...
    //进度回调
    UpHttpProgressBlock httpProgress = ^(int64_t completedBytesCount, int64_t totalBytesCount) {
    ...
    //成功回调
    UpHttpSuccessBlock httpSuccess = ^(NSURLResponse *response, id responseData) {
        NSError *error;
    ...
    //失败回调
    UpHttpFailBlock httpFail = ^(NSError * error) {
