...
@property (copy) UpHttpProgressBlock progressBlock;
@property (copy) UpHttpSuccessBlock successBlock;
@property (copy) UpHttpFailBlock failureBlock;
    ...
    if (error) {
        if (_failureBlock) {
            ...
            if (upError.code < NSURLErrorTimedOut &&
                ...
                upError = [[NSError alloc] initWithDomain:@"UPHTTPClient" code:499
                                                 userInfo:@{@"message":error.description}];
            }
